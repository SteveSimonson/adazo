...
- Created the Amazon Creators API application `Adazo` (`iu0e3-20.adazo`) under Associates Store ID `iu0e3-20`.
...
The OAuth token succeeds, but the first catalog request for an existing Adazo ASIN returns:
