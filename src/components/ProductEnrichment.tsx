...
import { ChevronDown, Sparkles, ThumbsDown, ThumbsUp, Wrench } from 'lucide-react'
    ...
    <div className="mt-16 space-y-16">
      ...
      <section aria-labelledby="review-snapshot-heading">
        <div className="flex items-end justify-between gap-4 mb-6">
          <div>
            <p className="label-micro mb-1">Signal from the field</p>
            <h2
      ...
      <section aria-labelledby="item-blog-heading">
        <div className="mb-6">
          <p className="label-micro mb-1 flex items-center gap-1.5">
            <Sparkles className="size-3.5 text-bamboo" />
            Adazo field notes
          </p>
          <h2
      ...
      {faq.length > 0 ? (
        <section aria-labelledby="faq-heading">
          <div className="mb-5">
            ...
            <h2 id="faq-heading" className="font-display text-2xl sm:text-3xl font-bold">
          ...
          {researchNotes && researchNotes.length > 0 ? (
            <p className="text-[11px] text-muted mt-4 leading-relaxed">
              ...
              {researchNotes.join(' · ')}
              ). Original Adazo copy—not scraped listings.
            </p>
          ) : (
            <p className="text-[11px] text-muted mt-4 leading-relaxed">
