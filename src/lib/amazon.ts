/**
 * Amazon Associates helpers for Adazo.
 * Tracking ID: set VITE_AMAZON_ASSOCIATE_TAG (Associates Store / Tracking ID).
 */
...
export function affiliateUrl(opts: {
  ...
  return amazonSearchUrl(opts.searchKeywords || `${opts.name} women beauty`)
}
