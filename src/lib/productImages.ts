...
const CATEGORY_PROMO_POOL: Partial<Record<string, string[]>> = {
  ...
  watches: [
    '/brand/categories/watches.jpg',
    '/brand/promo/nav-watches.jpg',
  ],
  gold: [
    '/brand/categories/gold.jpg',
    '/brand/promo/nav-gold.jpg',
    '/brand/vibes/gilded-scene.jpg',
  ],
...
export function quietPlaceholderUrl(product: {
  ...
  <text x="400" y="900" text-anchor="middle" font-family="system-ui,sans-serif" font-size="22" fill="${accent}" opacity="0.4">Adazo</text>
</svg>`
