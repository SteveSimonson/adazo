    ...
    return (
      <div className="max-w-lg mx-auto px-4 py-20 text-center">
        <Seo
          ...
          description="This buyer guide is not on Adazo."
          path={`/guides/${slug || ''}`}
          noindex
        />
    ...
    <div className="pb-24">
      ...
      >
        ...
        <p className="mt-4 text-xs text-muted leading-relaxed">
          Adazo guides are editorial. They are not medical advice. When skin or
          scalp concerns persist, talk to a clinician.
        </p>
      </article>
    </div>
  )
