  ...
  return (
    <div className="pb-24">
      ...
      <section className="relative border-b border-line bg-paper-2 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 py-16 sm:py-20">
          ...
          <h1 className="font-display text-4xl sm:text-6xl font-semibold max-w-2xl text-balance leading-[1.05]">
            Concerns first, then the shelf
          </h1>
          <p className="mt-4 text-lg text-ink-soft max-w-xl font-light leading-relaxed">
            High-intent beauty guides — retinol starts, SPF under makeup,
            sensitive cleansers, travel stacks, hair oil, winter body, lips,
            scalp habits, prestige creams, heat tools. Catalog-backed. Bought on
            Amazon.
          </p>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-14">
        <div className="mb-8">
          <p className="label-micro mb-1">Money keywords</p>
          <h2 className="font-display text-2xl sm:text-3xl font-semibold">
            {buyerGuides.length} field guides
          </h2>
        </div>
        ...
        <p className="mt-12 text-sm text-muted max-w-2xl">
          ...
          . These pages are job searches — not avatars. Editorial only; not
          medical advice.
        </p>
      </div>
    </div>
